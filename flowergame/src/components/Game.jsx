            ...
            >
                {
                    aliveCells.map(coords => {
                        ...
                        return pos ? <div key={`cell_${pos.x}_${pos.y}`}>
                            <Cell x={pos.x} y={pos.y}
                                  color={simulation ? constants.ALIVE_COLOR : constants.DRAW_COLOR}/>
                        </div> : null
                    })
                }
            </div>
            <div>
                <button onClick={simulate} disabled={simulation}>Go</button>
            </div>
